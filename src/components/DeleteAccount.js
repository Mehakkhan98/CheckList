  ...
  Alert.alert(
    ...
    getdata= async () => {
      ...
      if(this.props.client=="Student")
      {
        ...
        axios.post('http://192.168.8.103:4000/online_tutor_db/DeleteStudentAccount', newTodo)
       .then(Actions.login())
      ...
      if(this.props.client=="Teacher")
      {
        ...
        axios.post('http://192.168.8.103:4000/online_tutor_db/DeleteTeacherAccount', newTodo)
        .then(Actions.login())
